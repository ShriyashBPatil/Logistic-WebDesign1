        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="service.php">Air Freight</a>
                    <a class="btn btn-link" href="service.php">Sea Freight</a>
                    <a class="btn btn-link" href="service.php">Road Freight</a>
                    <a class="btn btn-link" href="service.php">Logistic Solutions</a>
                    <a class="btn btn-link" href="service.php">Industry solutions</a>
                </div>
                <div class="col-lg-3 col-md-6">
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="index.php">Logistica</a>, All Right Reserved.
                    </div>
